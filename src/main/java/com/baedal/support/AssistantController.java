 ...
 * <p>
 * ChatClient는 <b>요청마다가 아니라 생성자에서 1회만 build</b>한다.
 * ChatClient.Builder는 가변(mutable)이라 요청마다 {@code .defaultTools()}를 다시 부르면
 * 같은 빌더에 Tool이 누적되어 "Multiple tools with the same name" 예외가 발생한다.
 */
@RestController
